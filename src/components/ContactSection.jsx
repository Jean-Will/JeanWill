      ...
      <div className="max-w-5xl mx-auto px-4">  {/* 5x1 → 5xl */}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl bg-white border border-slate-200 p-4">
            ...
            <a 
              href="https://www.instagram.com/jean.will_/"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="rounded-xl bg-white border border-slate-200 p-4">
            ...
            <p className="text-xs md:text-sm text-slate-600">Projetos Web</p>
            <p className="text-xs md:text-sm text-slate-600">Telefone: +351 000 000 000</p>
            <p className="text-xs md:text-sm text-slate-600">Email: @.com</p>
          </div>
        </div>
      </div>
    </section>
